/**
 * SHA-256 for content-hash row identity (PRD §2.3).
 *
 * Self-contained (no Web Crypto, no Node crypto) so the hash is:
 *   - synchronous — ingestion stays a simple map, no async plumbing;
 *   - identical in the browser and in Node/Vitest — tests exercise the real
 *     row-id logic, not a mock.
 *
